...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="resources/css/naverCss.css"/>"/>
    ...
    <div class="main">
        <div class="midlogin">
            ...
            <div class="mainarea">
                ...
                <form action="naverLogin" method="post" name="user" onsubmit="return checkValue()">
                    ...
                    <div class="boxarea">
                        <input class="passwordarea inputfocus" id="pass1" name="pw" type="password" placeholder="비밀번호" style="width: 100%">
	                </div>
	                <div>
