...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="css/naverCss.css"/>"/>
    ...
    <div class="main">
        <div class="midlogin">
            ...
            <div class="mainarea">
                ...
                <form action="naverLogin" method="post" name="user" enctype="multipart/form-data" onsubmit="return checkValue()">
                    ...
                    <div class="boxarea">
                        <input class="passwordarea inputfocus" id="pass1" name="password" type="password" placeholder="비밀번호" style="width: 100%">
	                </div>
	                <div>
            ...
            <ul style="position: relative; top: 100px; right: 70px;">
                ...
                <li style="border-right:none;"><a href="naverAgree" >회원가입</a></li>
            </ul>
